...
{
    #[Route('/recette', name: 'app_recette_index', methods: ['GET','POST'])]
    ...
    #[Route('/recette/show/{id}', name: 'app_recette_show', methods: ['GET'])]
    ...
    #[Route('/recette/delete/{id}', name: 'app_recette_delete', methods: ['POST'])]
