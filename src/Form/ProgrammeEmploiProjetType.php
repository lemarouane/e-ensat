...
use App\Form\programmeElementProjetType;
...
class ProgrammeEmploiProjetType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
           ...
           /*  ->add('montant',NumberType::class, array('label' => 'Montant:',
            ...
            ->add('programmeElementProjets', CollectionType::class, [ 
                  'entry_type' => programmeElementProjetType::class,  
                  'entry_options' => [
                    'label' => $options['label'],
                    'help' => $options['help'],
                    'required' => false
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'App\Entity\ProgrammeEmploiProjet',
    ...
    {
        return 'ProgrammeEmploiProjetType';
    }
}
