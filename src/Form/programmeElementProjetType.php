...
class programmeElementProjetType extends AbstractType
{
        ...
        ->add('rubrique',EntityType::class, array('label' => 'Rubrique',
              ...
              'query_builder' => function (EntityRepository $er) use($options){
                if($options['help']==null){
                  ...
                  ->andwhere('a.id = :art')
                  ->andwhere('r.paragraphe = :help')
                  ->andwhere('r.affichage = :art1')
                  ->setParameter('art',$options['label'])
                  ->setParameter('help',$options['help'])
                  ->setParameter('art1','OUI');
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => ProgrammeElementProjet::class
        ));
    }
    ...
    {
        return 'programmeElementProjetType';
    }
