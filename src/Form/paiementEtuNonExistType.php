...
class paiementEtuNonExistType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ->add('anneeuniv',IntegerType::class, array('label' => 'annee_univ',
                'attr' => array(
                'class' => 'form-control',
                'min' => 0 ,
                ...
                ->add('formation',EntityType::class, array('label' => 'filiere',
                'mapped'=> false,
                'class' => FiliereFc::class,
                'placeholder' => '------------',
                'choice_label' => function ($fil_fc) {
                 
                 return $fil_fc->getCodeApo();
