...
class SituationAdm
{
    ...
    private ?string $libelleSituation = null;

    #[ORM\OneToMany(mappedBy: 'situationAdm', targetEntity: Personnel::class)]
    ...
    public function addPersonnel(Personnel $personnel): self
    {
        if (!$this->personnels->contains($personnel)) {
            ...
            $personnel->setSituationAdm($this);
        }
    ...
    public function removePersonnel(Personnel $personnel): self
    {
        if ($this->personnels->removeElement($personnel)) {
            ...
            if ($personnel->getSituationAdm() === $this) {
                $personnel->setSituationAdm(null);
            }
        }
