...
(function(global, factory) {
  ...
  var defaultOptions = {
    ...
    labelIdle: [
      '<p style="padding-left: 20%; padding-right: 20%; text-align: center; color: rgb(102, 102, 102); font-size: 24px;">Faites glisser le fichier ici, ou  <span class="filepond--label-action">cliquez pour le choisir depuis votre ordinateur</span></p>',
      Type.STRING
    ],
