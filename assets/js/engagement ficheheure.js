...
function addNewForm(){
	...
	var index = $collectionHolder.data('index');
	 ...
	 $("#ordre_mission_engagements_"+i).addClass("row g-3");
}
//remove them
...
/* $('#ordre_mission_dateDebut').change(function() {
	$('#ordre_mission_dateFin').datepicker('setStartDate', new Date($('#ordre_mission_dateDebut').val()) );
});

$('#ordre_mission_dateFin').change(function() {
	$('#ordre_mission_dateDebut').datepicker('setEndDate', new Date($('#ordre_mission_dateFin').val()) );
});
 */
...
$('.jsom-datepicker').datepicker({
  ...
  $(".jsom-datepicker").attr("autocomplete", "off");
  $(".jsom-datepicker").attr("autocomplete", "off");